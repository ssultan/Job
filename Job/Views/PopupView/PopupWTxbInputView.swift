//
//  PopupWTxbInputView.swift
//  Job
//
//  Created by Saleh Sultan on 8/19/20.
...
let Confirm_DELETE = "Please do not DELETE instance, unless you are instructed."
let EmailIcon = "EmailIcon"
let BarcodeIcon = "BarcodeSmIcon"
let WarningIcon = "WarningIcon"
let NO_CODE = "No Code"

class PopupWTxbInputView: UIViewController, UITextFieldDelegate {
                         ...
                         continueBlock:@escaping (_ mBarCode:String, _ isChecked:Bool)->())
    {
        ...
        if currentPopupType == PopupWithTxbType.DeleteIntance {
            ...
            checkBoxLabel.text = ""
            checkBoxNoBC.isHidden = true
            titleLbl.text = StringConstants.ButtonTitles.TLT_Warning
            subTitleLbl.text = Confirm_DELETE
